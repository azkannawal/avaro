...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Data Pemesanan /</span> List Data Pemesanan (Approve As Kepala Kantor)
        </h4>
                            ...
                            <tbody class="text-center" style="vertical-align:middle;">
                                ...
                                @forelse ($getData as $key => $ac)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('superAdmin.approveAsKepala.reject', $ac->id) }}"
                                                method="POST">
                                                @csrf
    ...
    @foreach ($getData as $key => $ac)
        <form id="formAccountSettings" method="POST" action="{{ route('superAdmin.approveAsKepala.approve', $ac->id) }}">
            @csrf
