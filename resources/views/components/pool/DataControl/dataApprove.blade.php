...
@section('content')
                            ...
                            <tbody class="text-center" style="vertical-align:middle;">
                                ...
                                @forelse ($getData as $key => $ac)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('pool.data-approve.isiBbm', $ac->id) }}" method="POST">
                                                @csrf
                                        ...
                                        <td>
                                            <form action="{{ route('pool.data-approve.reject', $ac->id) }}" method="POST">
                                                @csrf
    ...
    @foreach ($getData as $key => $ac)
        <form id="formAccountSettings" method="POST" action="{{ route('pool.data-approve.approve', $ac->id) }}">
            @csrf
    ...
    @foreach ($getData as $key => $ac)
        <form id="formAccountSettings" method="POST" action="{{ route('pool.data-approve.gantiService', $ac->id) }}">
            @csrf
