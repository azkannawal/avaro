...
@section('content')
                                ...
                                @forelse ($getData as $key => $ac)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($ac->status == 2)
                                                <span class="badge bg-primary">Menunggu Approve Anda</span>
                                            @elseif($ac->status == 3)
                                        ...
                                        <td>
                                            <form action="{{ route('kepalaKantor.data-approve.reject', $ac->id) }}"
                                                method="POST">
                                                @csrf
    ...
    @foreach ($getData as $key => $ac)
        <form id="formAccountSettings" method="POST" action="{{ route('kepalaKantor.data-approve.approve', $ac->id) }}">
            @csrf
