...
namespace App\Http\Controllers\Service\pool\DataControl;
...
class dataApproveController extends Controller
{
    ...
    public function approve(Request $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->route('pool.data-approve.index')->with('success', 'Data berhasil di approve');
        } catch (\Throwable $th) {
    ...
    public function gantiService(Request $request, string $id)
    {
        ...
        // Start Ganti Kendaraan
            if ($request->namaKendaraan == $findData->kendaraan->nama_kendaraan) {
                ...
                ->first();
                if ($findNewKendaraan == null) {
                    return redirect()->back()->with('error', 'Gagal mengganti kendaraan, kendaraan yang dipilih tidak tersedia');
                }
            }
            else {
